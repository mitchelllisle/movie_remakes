...
movieMetaData <- read.csv("data/movieMetaData.csv", stringsAsFactors = FALSE)
...
countByYear_chart(remakesByYear, c("#CFCFCF", "#AD55D0", "#F4465B"), "<b>UPWARD TREND IN RECENT YEARS OF MOVIE REMAKES</b>")
```
...
countByYear_chart(originalsByYear, c("#CFCFCF", "#4A90E2","#4A90E2"), "<b>DOWNWARD TREND IN MOVIES BEING REMADE</b>")
```
